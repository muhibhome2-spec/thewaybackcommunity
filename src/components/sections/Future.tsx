  ...
  return (
    <Section labelledBy="future-title">
      <Reveal>
        ...
        <CheckList
          className="mt-9 max-w-proseSm"
          items={futureOutcomes}
        />
        <p className="mt-[30px] font-mono text-kicker uppercase tracking-[0.1em] text-clay">
          All of it included, from £10.99 a month.
        </p>
        <div className="mt-9 flex">
          <Button variant="primary" to={site.anchors.included}>
